...
| **@Raff05B**       | 02.04.2026 | https://github.com/LeonidWouters/sopra-fs26-group-06-server/pull/40 | Implements Web Sockets auth logic in backend                                                                                                                                                    | Ensures that query token is checked upon web sockets connection establishment -> terminate connection if Invalid                                                                                                                                 |
| **@Raff05B**       | 02.04.2026 | https://github.com/LeonidWouters/sopra-fs26-group-06-client/pull/29 | Implements Web Sockets auth logic in frontend                                                                                                                                                   | Implements core web sockets useEffect hook in rooms and ensures token is sent, includes basic messaging feature for testing connection                                                                                                           |
